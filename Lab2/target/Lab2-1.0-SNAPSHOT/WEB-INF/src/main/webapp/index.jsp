...
<form action="/Lab2/table" method="get" id="tableValue">
  <div class="container mt-5">
    ...
    <div class="form-group row justify-content-center">
      <label class="col-sm-2 col-form-label" for="row">
    ...
    <div class="form-group row justify-content-center">
      <label class="col-sm-2 col-form-label" for="col">
    ...
    <div class="form-group row justify-content-center">
      <label class="col-sm-2 col-form-label" for="color">
        Колір фону:
      </label>
      <div class="col-sm-4">
        <input name="color" type="color" class="form-control" id="color" value="#5f9ea0">
      </div>
    </div>
  </div>
