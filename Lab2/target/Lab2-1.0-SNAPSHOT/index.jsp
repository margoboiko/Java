...
<form action="/Lab2/table" method="get" id="tableValue">
  <div class="container mt-5">
    ...
    <div class="form-group row justify-content-center">
      ...
      <div class="col-4">
        <input name="row" type="number" min="0" max="20" class="form-control" id="row" required>
      </div>
    </div>
    ...
    <div class="form-group row justify-content-center">
      ...
      <div class="col-4">
        <input name="col" type="number" min="0" max="20" class="form-control" id="col" required>
      </div>
    </div>

    <div class="form-group row justify-content-center">
      <label class="col-2 col-form-label" style="left: -142px;" for="color">
        Колір фону:
      </label>
      <div class="col-1"style="left: -142px;">
        <input name="color" type="color" class="form-control" style="height: 48px;" id="color" value="#5f9ea0" required>
      </div>
    </div>
  </div>
